<template>
    <div class="text-yellow fs-36 text-center animation-bg p-4 overflow-hidden">
      <div class="wrap-span z-10">
        <span>Cách</span> <span>tốt</span> <span>nhất</span> <span>để</span> <span>dự</span> <span>đoán</span> <span>tương</span> <span>lai</span> <span>là</span> <span>ngay</span> <span>từ</span> <span>bây</span> <span>giờ</span> <span>hãy</span> <span>tạo</span> <span>ra</span> <span>nó</span>
      </div>
    </div>  
</template>
  <style scoped>
  .animation-bg {
      ...
      height: 200px;
      position: relative;
      background: transparent url(@/assets/img/working_4.jpg) no-repeat center;
